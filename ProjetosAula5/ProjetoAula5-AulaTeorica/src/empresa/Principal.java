...
public class Principal {
	...
	//Tema 2
		...
		//Funcionario f2 = f1; //Uma referência tipo um ponteiro quando atribuido deste modo
		...
		Funcionario f;//instancia um objeto qualquer
		float total=0;
		for(int i=0; i<funcionarios.length;i++) {
			f= funcionarios[i]; // passa peloas objetos da array de Funcionario e adiciona no objeto criado f
			System.out.println(funcionarios[i].nome + " salario: " + f.pagamento());
			total += f.pagamento();
		}
